...
--Special summon hero from hand or gy
...
function s.spfilter(c,e,tp)
	return c:IsLevelBelow(7) and c:IsSetCard(0x8) and c:IsCanBeSpecialSummoned(e,0,tp,false,false) and not c:IsType(TYPE_FUSION)
end
